...
#define GAMMA_LEVEL_DEFAULT_TPO 7
...
static const LCD_INIT_TABLE TPO_0_TABLE[] = {
		{0x51, 0x0, 0},
};
...
/* combind power on/off to blank/unblank */
...
static int samsung_panel_uninit(struct msm_lcdc_panel_ops *ops)
{
	unsigned id, off = 1;
...
#ifdef CONFIG_MICROP_COMMON
static struct microp_bl_callback legend_backlight_control = {
	.bl_change = set_backlight_level,
};
#endif
...
#ifdef CONFIG_MICROP_COMMON
	microp_register_backlight_callback(&legend_backlight_control);
#endif
	return 0;
}
